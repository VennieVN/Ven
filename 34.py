...
def pipeline_model(img_path):
    ...
    faceDetectionModel = os.path.join(path, 'C:/Users/Admin/Desktop/Model/res10_300x300_ssd_iter_140000_fp16.caffemodel')
 
    # Face detection model architecture

    faceDetectionProto = os.path.join(path, 'C:/Users/Admin/Desktop/Model/deploy.prototxt.txt')
 
    # Face descriptor model

    faceDescriptor = os.path.join(path, 'C:/Users/Admin/Desktop/Model/openface.nn4.small2.v1.t7')
    ...
    face_recognition_model = pickle.load(open(os.path.join(path, 'C:/Users/Admin/Desktop/Model/ml_face_person_identity.pkl'), 'rb'))
...
image_path = os.path.join(path, 'C:/Users/Admin/Desktop/Model/image_40.jpg')
